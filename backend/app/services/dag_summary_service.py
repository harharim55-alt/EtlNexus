...
class DagSummaryService:
    ...
    async def _build_dag_summaries(
        ...
        # DAG metadata comes from Airflow when enabled; otherwise defaults are used below
        ...
        # Per-task run statuses (from Airflow when enabled; otherwise defaults to "unknown")

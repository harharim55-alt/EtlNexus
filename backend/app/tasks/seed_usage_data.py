...
SEED_USAGES: dict[str, list[dict]] = {
    "switch_port_collector": [
        {"consumer_name": "switch_port_collector", "usage_type": "etl", "description": None, "access_count": 18200, "days_ago": 0},
    ...
    "bgp_route_sync": [
        {"consumer_name": "bgp_route_sync", "usage_type": "etl", "description": None, "access_count": 9450, "days_ago": 0},
    ...
    "dns_record_sync": [
        {"consumer_name": "dns_record_sync", "usage_type": "etl", "description": None, "access_count": 5120, "days_ago": 0},
    ...
    "netflow_capture": [
        {"consumer_name": "netflow_capture", "usage_type": "etl", "description": None, "access_count": 7630, "days_ago": 0},
    ...
    "syslog_event_stream": [
        {"consumer_name": "syslog_event_stream", "usage_type": "etl", "description": None, "access_count": 12400, "days_ago": 0},
    ...
    "bandwidth_billing_aggregator": [
        {"consumer_name": "bandwidth_billing_aggregator", "usage_type": "etl", "description": None, "access_count": 3780, "days_ago": 0},
        ...
        {"consumer_name": "bandwidth_reports_api", "usage_type": "api", "description": "Feeds aggregated bandwidth data to reports API endpoint", "access_count": 365, "days_ago": 1},
    ],
    "device_fingerprint_enrichment": [
        {"consumer_name": "device_fingerprint_enrichment", "usage_type": "etl", "description": None, "access_count": 6890, "days_ago": 0},
        ...
        {"consumer_name": "network_insights_api", "usage_type": "api", "description": "Serves enriched device data via network insights API", "access_count": 3200, "days_ago": 0},
    ],
    "link_failure_prediction": [
        {"consumer_name": "link_failure_prediction", "usage_type": "etl", "description": None, "access_count": 8210, "days_ago": 0},
        ...
        {"consumer_name": "network_insights_api", "usage_type": "api", "description": "At-risk link scores for network insights API endpoint", "access_count": 4500, "days_ago": 0},
    ],
    "bandwidth_cost_reconciliation": [
        {"consumer_name": "bandwidth_cost_reconciliation", "usage_type": "etl", "description": None, "access_count": 4560, "days_ago": 0},
        ...
        {"consumer_name": "bandwidth_reports_api", "usage_type": "api", "description": "Reconciled bandwidth data for billing reports API", "access_count": 1890, "days_ago": 0},
    ],
    "noc_dashboard_snapshot": [
        {"consumer_name": "noc_dashboard_snapshot", "usage_type": "etl", "description": None, "access_count": 5340, "days_ago": 0},
    ],
    "incident_analytics_rollup": [
        {"consumer_name": "incident_analytics_rollup", "usage_type": "etl", "description": None, "access_count": 3890, "days_ago": 0},
    ],
    "network_insights_api": [
        {"consumer_name": "network_insights_api", "usage_type": "api", "description": None, "access_count": 9750, "days_ago": 0},
    ],
    "bandwidth_reports_api": [
        {"consumer_name": "bandwidth_reports_api", "usage_type": "api", "description": None, "access_count": 4120, "days_ago": 0},
    ],
}

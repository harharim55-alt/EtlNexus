"""Port Scan Collector - Periodic snapshot of network switch interface states."""
...
class PortScanCollector(BaseETL):
    def __init__(self, start_date, end_date=None):
        ...
        self.etl_name = "PortScanCollector"

    def extract(self):
        self.ports = self.spark.table("iceberg.dagger.PortScanCollector")

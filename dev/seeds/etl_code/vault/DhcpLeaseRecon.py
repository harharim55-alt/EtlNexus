"""DHCP Lease Recon - Ingests leases, pools, and reservations from DHCP server API."""
...
class DhcpLeaseRecon(BaseETL):
    def __init__(self, start_date, end_date=None):
        ...
        self.etl_name = "DhcpLeaseRecon"

    def extract(self):
        self.leases = self.spark.table("iceberg.vault.DhcpLeaseRecon")

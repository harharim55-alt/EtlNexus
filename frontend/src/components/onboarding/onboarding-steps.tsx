...
const ALL_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "New Data Product: name, description, documentation, tables",
      "A tab per table (schema + consume) + product read_by_tag snippet",
    ],
  },
  {
    id: "tables",
    title: "Tables",
    subtitle: "MODULE: CATALOG_TABLES",
    description:
      "Every Iceberg table discoverable in the catalog, filterable by team and name. Open any table to see its schema and its consume snippet. Data products are built from these tables.",
    icon: Table2,
    iconBg: "bg-cyan-500/10",
    iconBorder: "border-cyan-500/20",
    iconText: "text-cyan-400",
    dotColor: "bg-cyan-400/60",
    spotlightTarget: "tables",
    sectionTarget: "tables-view",
    navigateTo: "tables",
    panelPosition: "bottom-right",
    features: [
      "All catalog tables from Spark Connect",
      "Filter by team + name",
      "Per-table schema + consume snippet",
    ],
  },
  {
    id: "ai",

...
const ALL_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    subtitle: "MODULE: SENSOR_WATCH",
    description:
      "Track Airflow sensors across your ecosystem. Filter by team, view sensor topologies, and monitor the watchers that keep your pipelines triggered on time.",
    icon: Radio,
    iconBg: "bg-teal-500/10",
    iconBorder: "border-teal-500/20",
    iconText: "text-teal-400",
    dotColor: "bg-teal-400/60",
    spotlightTarget: "sensors",
    sectionTarget: "sensors-view",
    navigateTo: "sensors",
    panelPosition: "bottom-right",
    features: [
      "Team-filtered sensor overview",
      "Sensor topology visualization",
      "Status monitoring for all sensor types",
    ],
  },
  {
    id: "ai",
